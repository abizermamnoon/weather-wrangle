...
#The code below depicts a map of the US and its average number of sunny days range in 2016. Each US state in the map is colored with a shade of blue that represents a number of average minimum temperature. The lower the number, the darker the shade of blue the state will be.
...
#The code below depicts a map of the US and its average number of percipitation in 2016. Each US state in the map is colored with a shade of blue that represents a number of amount of percipitation. The lower the number, the darker the shade of blue the state will be.
```{r echo = FALSE}
MainStates <- map_data("state")
...
#The code below depicts a map of the US and its average number of wind speed in 2016. Each US state in the map is colored with a shade of blue that represents a number of wind speed. The lower the number, the darker the shade of blue the state will be.
```{r echo = FALSE}
MainStates <- map_data("state")
...
```
States around Arkansas tend to have
## Turn in:
