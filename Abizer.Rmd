...
Consistent %>% ggplot(aes(x = reorder(month,mn), y = mn-15)) + geom_bar(stat = 'identity')  +  xlab("Months") + ylab("Average Temperature Range (F) -15 ") + coord_flip() +ggtitle("Average Temperature Range per Month") + geom_text(aes(label = mn),nudge_y = 0.5, size = 2)
```
...
Sunny %>% ggplot(aes(x = reorder(month,mn), y = mn - 5)) + geom_bar(stat = 'identity') + coord_flip() + xlab("Months") + ylab("Mean Number of Sunny Days - 5") + ggtitle("Average Number of Sunny Days per Month") + geom_text(aes(label = mn),nudge_y = 0.5, size = 2)
```
