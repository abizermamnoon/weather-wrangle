...
States in the East have more consistent temperatures than states in the West.There are more variable temperatures in the West. Florida is the state with the lowest average temperature range while New Mexico is state with the most highest average temperature range. 
...
#The code below depicts a map of the US and its average wind speed in 2016. Each US state in the map is colored with a shade of blue that represents wind speed. The higher the number, the darker the shade of blue the state will be.
```{r echo = FALSE}
MainStates <- map_data("state")
